...
public class Player{
    ...
    private static String[] cardinalDirections = {"NORTH", "EAST", "SOUTH", "WEST"};
    ...
    public String move(String direction, String speed){
        ...
        System.out.print(getLocation().iPos);
        System.out.println(getLocation().jPos);

        World.getInstance(10).movePlayer(this, direction); // move the player in direction

        System.out.print(getLocation().iPos);
        System.out.println(getLocation().jPos);
        return ("You " + speed + " in the " + direction + ". As you stop you see " + World.getInstance(10).seenBiomes(getLocation()));
    }
